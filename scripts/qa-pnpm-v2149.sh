...
async function*Pf(){let j6={mode:"default"},Z6=[],w1=!1,u=0;yield{type:"result",subtype:"success",is_error:w1,duration_ms:Date.now()-u}}
VERSION:"2.1.49"
EOF
...
grep -Fq 'if((j6?.mode)==="neverStop")' "$JS_TARGET"
